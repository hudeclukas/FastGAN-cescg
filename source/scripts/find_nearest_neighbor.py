...
from operation import load_parameters, InfiniteSamplerWrapper
...
load_parameters(net_ig, checkpoint["g_ema"])
...
for j in range(8):
    ...
    for n in range(batch):
        ...
        vutils.save_image(
            torch.cat([F.interpolate(the_image, 256), close_0]).add(1).mul(0.5),
